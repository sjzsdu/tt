...
export function useMermaidViewport(svg: string) {
  ...
  return { viewportRef, containerRef, svgElRef, panZoomTarget, baseSize, initialState, viewportHeight, displaySvg };
}
